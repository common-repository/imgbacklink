...
function hl2l(e){
	...
	ndi.style.width = (tw - 10)+"px";
	ndi.style.padding = "3px";
	ndi.innerHTML = "If you wish to use this image elsewhere, please select either HTML (for webpages) or BBCODE (for forums) and use the code provided:";
